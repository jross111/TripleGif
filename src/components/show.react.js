  ...
  <container id="container">
    <div id="content">
      ...
      <div className= "horizontal div3">
        <h1 id={this.props.words[0].text_theme}> {this.props.term_1} </h1>
    ...
    <div id="primary">
        <div className="horizontal div3">
          <h1 id={this.props.words[1].text_theme}> {this.props.term_2} </h1>
    ...
    <div id="secondary">
      <div className="horizontal div3">
        <h1 id={this.props.words[2].text_theme}> {this.props.term_3} </h1>
